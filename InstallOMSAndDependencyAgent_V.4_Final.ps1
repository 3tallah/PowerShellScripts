...
$Shared = "\\azmigappliance\OMSLogs" # Use Create Shared Folder With Read Access to Everyone
# Microsoft Monitoring Agent (MMA) https://go.microsoft.com/fwlink/?LinkId=828603
# Azure Dependency Agent https://aka.ms/dependencyagentwindows
# OMS Gateway https://go.microsoft.com/fwlink/?linkid=837444
